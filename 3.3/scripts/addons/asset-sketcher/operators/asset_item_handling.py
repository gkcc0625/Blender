...
class ASSET_SKETCHER_OT_AddCanvasItem(bpy.types.Operator):
...
class ASSET_SKETCHER_OT_RemoveCanvasItem(bpy.types.Operator):
...
class ASSET_SKETCHER_OT_AddAssetToCategory(bpy.types.Operator):
...
class ASSET_SKETCHER_OT_RemoveAssetToCategory(bpy.types.Operator):
...
class ASSET_SKETCHER_OT_AddAssetCategory(bpy.types.Operator):
...
class ASSET_SKETCHER_OT_RemoveAssetCategory(bpy.types.Operator):
...
class ASSET_SKETCHER_OT_AddAssetItem(bpy.types.Operator):
                ...
                if obj.type == "MESH" and len(selected_objects) == 1:
                    ...
                    if obj.instance_collection != None:
                        for obj2 in obj.instance_collection.objects:
                            obj2["as_asset"] = True
                            obj2["as_instance_collection"] = obj.name
                    item.type = "EMPTY"
                    ...
                    for obj2 in selected_objects:
                        ...
                        if obj2.type == "EMPTY" and obj2.instance_collection != None:
                            for obj3 in obj2.instance_collection.objects:
                                obj3["as_asset"] = True
                                obj3["as_instance_collection"] = obj2.name
...
class ASSET_SKETCHER_OT_RemoveAssetItem(bpy.types.Operator):
...
class ASSET_SKETCHER_OT_SelectObjects(bpy.types.Operator):
