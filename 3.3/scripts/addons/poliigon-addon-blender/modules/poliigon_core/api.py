...
class PoliigonConnector():
    ...
    def register_update(self, addon_v: str, software_v: str) -> None:
        ...
        self.common_meta = {
            ...
            "addon_software_name": self.software_source
        }
    ...
    def _request_stream(self,
        ...
        print("What is the erro?", error)
        print("What is the response?", res.text)
    ...
    def _signal_event(self, event_name: str, payload: Dict) -> ApiResponse:
        ...
        return self._request_authenticated(f"/t/{event_name}", payload=payload)
    ...
    def _update_meta_payload(self, payload: Dict) -> Dict:
        ...
        if self._is_opted_in():
            ...
            payload["meta"]["addon_software_version"] = self.software_version
        else:
