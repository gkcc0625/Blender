...
classes = {'CORE': [('properties', [('HistoryObjectsCollection', ''),
           ...
           'ASSETBROWSER': [('operators.assetbrowser', [('AssembleCollectionInstance', 'assemble_collection_instance'),
           ...
           'SHADING_PIE': [('ui.pies', [('PieShading', 'shading_pie')]),
                           ...
                           ('ui.operators.overlay', [('ToggleGrid', 'toggle_grid'),
                                                     ...
                                                     ('ToggleObjectAxes', 'toggle_object_axes')]),
                           ('ui.operators.mesh', [('ShadeSmooth', 'shade_smooth'),
