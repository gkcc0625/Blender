...
classes = {"CORE": [("ui.UILists", [("DecalLibsUIList", ""),
                    ...
                    ("ui.operators.libraries", [("Move", "move_decal_library"),
                                                ...
                                                ("ResetDECALmachineAssetsLocation", "reset_decalmachine_assets_location")]),
           ...
           "CREATE": [("operators.create", [("Create", "create_decal"),
                                            ...
                                            ("Update18DecalLibrary", "update_18_decal_library"),
                                            ("Update20DecalLibrary", "update_20_decal_library"),
                                            ("Update21DecalLibrary", "update_21_decal_library"),
                                            ("Update18BlendFile", "update_18_blend_file"),
                                            ("Update20BlendFile", "update_20_blend_file"),
                                            ("Update21BlendFile", "update_21_blend_file"),
