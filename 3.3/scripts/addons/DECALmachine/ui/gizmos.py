...
from .. utils.math import flatten_matrix, get_sca_matrix, trimmx_to_img_coords, mul
...
class GizmoGroupTrimSheet(bpy.types.GizmoGroup):
    ...
    def initialize_trim_gizmos(self):
        ...
        for trim in trims:
            ...
            gzm.target_set_handler("matrix", get=trim_getter(trim), set=trim_setter(sheet, trims, trim))


def trim_getter(trim):
