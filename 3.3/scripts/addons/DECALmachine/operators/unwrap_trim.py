...
from .. utils.ui import init_cursor, draw_init, draw_title, draw_prop, popup_message, draw_info, init_status, finish_status
from .. utils.material import get_trimsheet_material_from_faces, remove_trimsheetmat, assign_trimsheet_material
...
class TrimUnwrap(bpy.types.Operator, Settings):
    ...
    def modal(self, context, event):
        ...
        events = ['WHEELUPMOUSE', 'WHEELDOWNMOUSE', 'ONE', 'TWO', 'F']
        ...
        if trimuuid and self.trim:
            ...
            if selected:
                ...
                if context.space_data.type == 'VIEW_3D':
                    ...
                    self.HUD = bpy.types.SpaceImageEditor.draw_handler_add(self.draw_HUD, (args, ), 'WINDOW', 'POST_PIXEL')
