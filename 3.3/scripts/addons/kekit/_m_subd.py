...
class UISubDModule(Panel):
    ...
    def draw(self, context):
        ...
        col.prop(context.scene.kekit, "subd_autosmooth")
...
class KeSubd(Operator):
    ...
    def execute(self, context):
        vp_level = context.scene.kekit.vp_level
        render_level = context.scene.kekit.render_level
        flat_edit = context.scene.kekit.flat_edit
        limit_surface = context.scene.kekit.limit_surface
        boundary_smooth = context.scene.kekit.boundary_smooth
        optimal_display = context.scene.kekit.optimal_display
        on_cage = context.scene.kekit.on_cage
        use_autosmooth = context.scene.kekit.subd_autosmooth
