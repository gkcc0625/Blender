...
from ._utils import get_scene_unit, get_face_islands, pick_closest_edge
...
class UIMultiCutModule(Panel):
    ...
    def draw(self, context):
        toggle = bpy.context.scene.kekit_temp.toggle
        ...
        row = col.row(align=True)
        row.prop(bpy.context.scene.kekit_temp, "toggle", text="Manual Rename", toggle=True)
...
class KeMultiCutPrefs(Operator):
    ...
    def execute(self, context):
        ...
        if self.preset == 0:
            ...
            bpy.context.scene.kekit.mc_name0 = set_name(v1, v2, v3, v4)
        elif self.preset == 1:
            p[4], p[5], p[6], p[7] = v1, v2, v3, v4
            bpy.context.scene.kekit.mc_name1 = set_name(v1, v2, v3, v4)
        elif self.preset == 2:
            p[8], p[9], p[10], p[11] = v1, v2, v3, v4
            bpy.context.scene.kekit.mc_name2 = set_name(v1, v2, v3, v4)
        elif self.preset == 3:
            p[12], p[13], p[14], p[15] = v1, v2, v3, v4
            bpy.context.scene.kekit.mc_name3 = set_name(v1, v2, v3, v4)
        elif self.preset == 4:
            p[16], p[17], p[18], p[19] = v1, v2, v3, v4
            bpy.context.scene.kekit.mc_name4 = set_name(v1, v2, v3, v4)
        elif self.preset == 5:
            p[20], p[21], p[22], p[23] = v1, v2, v3, v4
            bpy.context.scene.kekit.mc_name5 = set_name(v1, v2, v3, v4)
        elif self.preset == 6:
            p[24], p[25], p[26], p[27] = v1, v2, v3, v4
            bpy.context.scene.kekit.mc_name6 = set_name(v1, v2, v3, v4)
        elif self.preset == 7:
            p[28], p[29], p[30], p[31] = v1, v2, v3, v4
            bpy.context.scene.kekit.mc_name7 = set_name(v1, v2, v3, v4)
        return {'FINISHED'}
...
def register():
    if bpy.context.preferences.addons[__package__].preferences.m_multicut:
        try:
            if not bpy.context.preferences.addons[__package__].preferences.m_modeling:
                UIMultiCutModule.bl_category = __package__
                UIMultiCutModule.bl_parent_id = ""
            else:
                UIMultiCutModule.bl_category = ""
                UIMultiCutModule.bl_parent_id = "UI_PT_M_MODELING"
...
def unregister():
    if "bl_rna" in UIMultiCutModule.__dict__:
