...
from bpy.props import FloatProperty, IntProperty, BoolProperty, StringProperty, FloatVectorProperty, PointerProperty, CollectionProperty, EnumProperty
import math
import bmesh
...
class MyPropertiesQT(bpy.types.PropertyGroup):
    ...
    random_hue: FloatProperty(
        name="random_hue",
        description="random_hue",
        default = 0
        )  

    random_val: FloatProperty(
        name="random_val",
        description="random_val",
        default = 0
        )  

    random_contrast: FloatProperty(
        name="random_contrast",
        description="random_contrast",
        default = 0
        )  

    random_sat: FloatProperty(
        name="random_sat",
        description="random_sat",
        default = 0
        )  

    random_seed: FloatProperty(
        name="random_seed",
    ...
    triplanar: BoolProperty(
        name="triplanar",
        description="Triplanar Blend",
        default = 0
        ) 
    ...
    bakepath: StringProperty(
        name="bakepath",
        description="Bake Output Directory Path",
        default = ""
        )

    bakename: StringProperty(
        name="bakename",
        description="Baked Texture Name",
        default = "bakeMat"
        )
    ...
    smudge_bright_contrast: FloatProperty(
        name="uv_bright_contrast",
        description="uv_bright_contrast",
        default = 1
        )  

    smudge_hue_sat: FloatProperty(
        name="uv_hue_sat",
        description="uv_hue_sat",
        default = 1
        )  
    ...
    samples: IntProperty(
        name="samples",
        description="Cycles Bake Samples",
        default = 64,
        min = 1,
        max = 10000
		) 
...
class QT_PT_panel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        row = box.row()   
        row.prop(bpy.context.window_manager.my_toolqt, 'res', text='Decal Resolution', slider=1)
        box = layout.box()
        row = box.row()    
        ...
        row = box.row()    
        row.label(text="Ctrl + A = Color/Alpha Opacity Toggle")
        row = box.row()    
        row.label(text="Backspace = Delete Mask")
        box = layout.box()
        row = box.row()    
        row.prop(bpy.context.window_manager.my_toolqt, 'forceprocedural', text='Force Procedural UVs', slider = False)
        box = layout.box()
        row = box.row()    
        ...
        row = box.row()    
        row.prop(bpy.context.window_manager.my_toolqt, 'bakename', text='Bake Texture Name')
        row = box.row()    
        row.prop(bpy.context.window_manager.my_toolqt, 'bakepath', text='Bake Output Directory')
        row.operator(BakeFileSelector.bl_idname, icon="FILE_FOLDER", text="")
        row = box.row() 
        row.prop(bpy.context.window_manager.my_toolqt, 'bakeres', text='Bake Resolution', slider=1)
        row = box.row() 
        row.prop(bpy.context.window_manager.my_toolqt, 'samples', text='Bake Samples', slider=1)
        row = box.row() 
        row.prop(bpy.context.window_manager.my_toolqt, 'save_original_mat', text='Save Original Mat', slider = False)
...
# TEXT
        ...
        if bpy.context.window_manager.my_toolqt.blend or bpy.context.window_manager.my_toolqt.mask:
            ...
            if bpy.context.window_manager.my_toolqt.activemap == 1:        
                ...
                text3 = '(C) Contrast: ' + str(round(bpy.context.window_manager.my_toolqt.diffuse_contrast, 2))
                text4 = '(X) Saturation: ' + str(round(bpy.context.window_manager.my_toolqt.diffuse_sat, 2))
            ...
            if bpy.context.window_manager.my_toolqt.activemap == 5:        
                ...
                text3 = '(C) Contrast: ' + str(round(bpy.context.window_manager.my_toolqt.alpha_bright_contrast, 2))
            ...
            if bpy.context.window_manager.my_toolqt.activemap == 6:     
                if self.diffuse_tex.projection == 'FLAT':
                    ...
                    triblend = 'On'
                text1 = '(H) UV Blend Amount: ' + str(round(bpy.context.window_manager.my_toolqt.tiling_blend_amount, 2))
                text2 = '(V) UV Blend Noise: ' + str(round(bpy.context.window_manager.my_toolqt.tiling_blend_noise, 2))
                text3 = '(C) Triplanar Blend: ' + triblend

            # uv
            if bpy.context.window_manager.my_toolqt.activemap == 7:        
                text1 = '(Ctrl I) Invert'
                text2 = '(V) Value: ' + str(round(bpy.context.window_manager.my_toolqt.smudge_hue_sat, 2))
                text3 = '(C) Contrast: ' + str(round(bpy.context.window_manager.my_toolqt.smudge_bright_contrast, 2))

            if bpy.context.window_manager.my_toolqt.activemap > 1 and bpy.context.window_manager.my_toolqt.activemap != 8: 
                dim_x = blf.dimensions(font_id, text3)[0]+30
                blf.position(font_id, self.regX-dim_x-uiWidth, space * 3, 0)
                blf.color(font_id, bpy.context.preferences.addons[__package__].preferences.col_primary[0], bpy.context.preferences.addons[__package__].preferences.col_primary[1], bpy.context.preferences.addons[__package__].preferences.col_primary[2], bpy.context.preferences.addons[__package__].preferences.col_primary[3])
                blf.draw(font_id, text1)
            ...
            if bpy.context.window_manager.my_toolqt.activemap == 8:        
                text1 = '(H) Hue: ' + str(round(bpy.context.window_manager.my_toolqt.random_hue, 2))         
                text2 = '(V) Value: ' + str(round(bpy.context.window_manager.my_toolqt.random_val, 2))
                text3 = '(C) Roughness: ' + str(round(bpy.context.window_manager.my_toolqt.random_contrast, 2))
                text4 = '(X) Saturation: ' + str(round(bpy.context.window_manager.my_toolqt.random_sat, 2))
                text5 = '(Ctrl I) Hue Seed: ' + str(round(bpy.context.window_manager.my_toolqt.random_seed, 2))
    ...
    def modal(self, context, event):
        ...
        if bpy.context.window_manager.my_toolqt.selected:
            if bpy.context.window_manager.my_toolqt.ob:
                if len(bpy.context.window_manager.my_toolqt.ob.material_slots) > 0:
                    self.mat = bpy.context.window_manager.my_toolqt.ob.material_slots[bpy.context.window_manager.my_toolqt.matindex].material
                        ...
                        if self.nodes:
                            for n in self.nodes:
                                ...
                                if n.name.startswith('QT_Diffuse_Bright_Contrast_' + str(bpy.context.window_manager.my_toolqt.activelayer)):
                                    ...
                                    bpy.context.window_manager.my_toolqt.diffuse_contrast = self.diffuse_bright_contrast.inputs[2].default_value
                                ...
                                # tiling
                                if n.name.startswith('QT_Diffuse_Seamless_' + str(bpy.context.window_manager.my_toolqt.activelayer)):
                                    self.diffuse_seamless = n
                                if n.name.startswith('QT_Rough_Seamless_' + str(bpy.context.window_manager.my_toolqt.activelayer)):
                                    self.rough_seamless = n
                                if n.name.startswith('QT_Bump_Seamless_' + str(bpy.context.window_manager.my_toolqt.activelayer)):
                                    self.bump_seamless = n
                                if n.name.startswith('QT_Alpha_Seamless_' + str(bpy.context.window_manager.my_toolqt.activelayer)):
                                    self.alpha_seamless = n
                                if n.name.startswith('QT_Smudge_' + str(bpy.context.window_manager.my_toolqt.activelayer)):
                                    self.smudge = n

                                # uv
                                if n.name.startswith('QT_Tex_Smudge_' + str(bpy.context.window_manager.my_toolqt.activelayer)):
                                    self.smudge_tex = n
                                if n.name.startswith('QT_Bright_Contrast_Smudge_' + str(bpy.context.window_manager.my_toolqt.activelayer)):
                                    self.smudge_bright_contrast = n
                                    bpy.context.window_manager.my_toolqt.smudge_contrast = self.smudge_bright_contrast.inputs[2].default_value
                                if n.name.startswith('QT_Invert_Smudge_' + str(bpy.context.window_manager.my_toolqt.activelayer)):
                                    self.smudge_invert = n
                                if n.name.startswith('QT_Hue_Sat_Smudge_' + str(bpy.context.window_manager.my_toolqt.activelayer)):
                                    self.smudge_hue_sat = n
                                    bpy.context.window_manager.my_toolqt.smudge_hue_sat = self.smudge_hue_sat.inputs[2].default_value
                                if n.name.startswith('QT_Mapping_Smudge_' + str(bpy.context.window_manager.my_toolqt.activelayer)):
                                    self.smudge_mapping = n

                                # random
                                if n.name.startswith('QT_RandColor_' + str(bpy.context.window_manager.my_toolqt.activelayer)):
                                    self.randcolor = n
                                if n.name.startswith('QT_RandVal_' + str(bpy.context.window_manager.my_toolqt.activelayer)):
                                    self.randval = n
        ...
        try:
            ...
            if event.type in {'LEFTMOUSE', 'ENTER'} and event.value == 'PRESS':
                ...
                if self.g or self.s or self.r or self.l or self.e or self.shifth or self.shifts or self.alts or self.shiftb or self.shiftn or self.ctrli or self.h or self.v or self.c or self.o or self.a or self.x:
                    self.g = 0
                    self.s = 0
                    self.r = 0
                    self.l = 0
            ...
            if event.type == 'MOUSEMOVE':   
                        ...
                        if bpy.context.window_manager.my_toolqt.blend or bpy.context.window_manager.my_toolqt.mask: 
                            ...
                            if bpy.context.window_manager.my_toolqt.activemap == 1:
                                ...
                                if self.smudge_mapping:
                                    self.smudge_mapping.inputs[1].default_value[0] += xval * dist
                                    self.smudge_mapping.inputs[1].default_value[1] += yval * dist
                ...
                if self.s:
                    ...
                    if bpy.context.window_manager.my_toolqt.activemap == 1:
                        ...
                        for n in self.nodes:
                            if n.type == 'MAPPING':
                                if not n.name.startswith('QT_Mapping_'):
                                    n.inputs[3].default_value[0] += delta * n.inputs[3].default_value[0]
                                    n.inputs[3].default_value[1] += delta * n.inputs[3].default_value[1]
                                    n.inputs[3].default_value[2] += delta * n.inputs[3].default_value[2]

                    elif bpy.context.window_manager.my_toolqt.activemap == 7:
                        if self.smudge_mapping:
                            self.smudge_mapping.inputs[3].default_value[0] += delta * self.smudge_mapping.inputs[3].default_value[0]
                            self.smudge_mapping.inputs[3].default_value[1] += delta * self.smudge_mapping.inputs[3].default_value[1]
                            self.smudge_mapping.inputs[3].default_value[2] += delta * self.smudge_mapping.inputs[3].default_value[2]  
                ...
                if self.e:
                    ...
                    if bpy.context.window_manager.my_toolqt.blend or bpy.context.window_manager.my_toolqt.mask:
                        ...
                        bpy.context.window_manager.my_toolqt.emit = self.core_shader.inputs[20].default_value
                ...
                if self.shifth:
                    ...
                    if bpy.context.window_manager.my_toolqt.blend or bpy.context.window_manager.my_toolqt.mask:
                        ...
                        bpy.context.window_manager.my_toolqt.spec = self.core_shader.inputs[7].default_value
                    ...
                    if bpy.context.window_manager.my_toolqt.blend or bpy.context.window_manager.my_toolqt.mask:
                        ...
                        if bpy.context.window_manager.my_toolqt.activemap == 6:
                            ...
                            if self.diffuse_seamless:
                                self.diffuse_seamless.inputs[1].default_value += delta * 20
                                ...
                                bpy.context.window_manager.my_toolqt.tiling_blend_amount = self.diffuse_seamless.inputs[1].default_value

                                self.rough_seamless.inputs[1].default_value = bpy.context.window_manager.my_toolqt.tiling_blend_amount
                                self.bump_seamless.inputs[1].default_value = bpy.context.window_manager.my_toolqt.tiling_blend_amount
                                if self.alpha_seamless:
                                    self.alpha_seamless.inputs[1].default_value = bpy.context.window_manager.my_toolqt.tiling_blend_amount
                        ...
                        if bpy.context.window_manager.my_toolqt.activemap == 8:
                            if self.randcolor:
                                ...
                                bpy.context.window_manager.my_toolqt.random_hue = self.randcolor.inputs[2].default_value
                    ...
                    if bpy.context.window_manager.my_toolqt.blend or bpy.context.window_manager.my_toolqt.mask:
                        ...
                        if bpy.context.window_manager.my_toolqt.activemap == 6:
                            ...
                            if self.diffuse_seamless:
                                ...
                                bpy.context.window_manager.my_toolqt.tiling_blend_noise = self.diffuse_seamless.inputs[2].default_value

                                self.rough_seamless.inputs[2].default_value = bpy.context.window_manager.my_toolqt.tiling_blend_noise
                                self.bump_seamless.inputs[2].default_value = bpy.context.window_manager.my_toolqt.tiling_blend_noise
                                if self.alpha_seamless:
                                    self.alpha_seamless.inputs[2].default_value = bpy.context.window_manager.my_toolqt.tiling_blend_noise

                        if bpy.context.window_manager.my_toolqt.activemap == 7:

                            if self.smudge_hue_sat:
                                self.smudge_hue_sat.inputs[2].default_value += delta * 20
                        ...
                        if bpy.context.window_manager.my_toolqt.activemap == 8:
                            ...
                            if self.randcolor:
                                ...
                                bpy.context.window_manager.my_toolqt.random_val = self.randcolor.inputs[4].default_value
                ...
                if self.c:
                    ...
                    if bpy.context.window_manager.my_toolqt.blend or bpy.context.window_manager.my_toolqt.mask:
                        ...
                        if bpy.context.window_manager.my_toolqt.activemap == 1:
                            ...
                            if self.diffuse_bright_contrast.inputs[2].default_value < -30:
                                self.diffuse_bright_contrast.inputs[2].default_value = -30
                            if self.diffuse_bright_contrast.inputs[2].default_value > 30:
                                self.diffuse_bright_contrast.inputs[2].default_value = 30
                        ...
                        if bpy.context.window_manager.my_toolqt.activemap == 7:
                            ...
                            bpy.context.window_manager.my_toolqt.smudge_bright_contrast = self.smudge_bright_contrast.inputs[2].default_value
                        ...
                        if bpy.context.window_manager.my_toolqt.activemap == 8:
                            ...
                            if self.randval:
                                ...
                                bpy.context.window_manager.my_toolqt.random_contrast = self.randval.inputs[1].default_value[2]
                ...
                if self.x:
                    ...
                    if bpy.context.window_manager.my_toolqt.blend == 0 and bpy.context.window_manager.my_toolqt.mask == 0:
                        ...
                        if bpy.context.window_manager.my_toolqt.activemap == 8:
                            if self.randcolor:
                                self.randcolor.inputs[3].default_value += delta * 20
                                ...
                                bpy.context.window_manager.my_toolqt.random_sat = self.randcolor.inputs[3].default_value
...
# 
                ...
                if bpy.context.window_manager.my_toolqt.blend == 0 and bpy.context.window_manager.my_toolqt.mask == 0:  
                    ...
                    for modifier in bpy.context.window_manager.my_toolqt.ob.modifiers:
                        ...
                        if modifier.name.startswith('QT_Decal'):
                            ...
                            normal = Vector((self.rv3d.perspective_matrix[2][0:3])).normalized()
                            ...
                            bpy.context.window_manager.my_toolqt.ob.rotation_euler = self.rv3d.view_rotation.to_euler()
                ...
                if event.value == 'PRESS':
                    ...
                    if bpy.context.window_manager.my_toolqt.blend == 0 and bpy.context.window_manager.my_toolqt.mask == 0: 
                        ...
                        if self.ctrl == 1 and self.shift == 0 and self.alt == 0:
                            ...
                            mask = 0
                            for n in self.nodes:
                                if n.name.endswith('Smudge_Tex_' + str(bpy.context.window_manager.my_toolqt.activelayer)):
                                    mask = 1
            ...
            elif event.type in {'F1', 'F2', 'F3', 'F4', 'F5', 'F6', 'F7', 'F8', 'F9', 'F10', 'F11', 'F12'}:
                return {'PASS_THROUGH'}
            ...
            # SATURATION
                ...
                if event.value == 'PRESS':
                    ...
                    if self.alt:
                        ...
                        if bpy.context.window_manager.my_toolqt.activemap == 6:
                            if self.tex_coord.label == 'Box' or self.tex_coord.label == 'UV':
                                if self.diffuse_tex:
                                    
                                    if self.diffuse_tex.projection == 'FLAT':

                                        bpy.context.window_manager.my_toolqt.triplanar = 1
                                        ...
                                        bpy.context.window_manager.my_toolqt.triplanar = 0
                                        ...
                                        if self.tex_coord.label == 'UV':
                                            ...
                                            if self.mask_tex:
                                                ...
                                                self.node_tree.links.new(self.tex_coord.outputs[2], self.mask_mapping.inputs[0])
            ...
            # INVERT
                ...
                if self.ctrl:
                    if bpy.context.window_manager.my_toolqt.activemap == 2:
                        ...
                        self.smudge_invert.inputs[0].default_value = not self.smudge_invert.inputs[0].default_value    

                    elif bpy.context.window_manager.my_toolqt.activemap == 8:
                        if self.randcolor:
                            self.randcolor.inputs[1].default_value += 0.1
                            bpy.context.window_manager.my_toolqt.random_seed = self.randcolor.inputs[1].default_value
                ...
                if bpy.context.window_manager.my_toolqt.activelayer < 5:
                    ...
                    for node in nodes:
                        if node.type != 'GROUP_OUTPUT':
                            ...
                            ignore_attributes = ( "rna_type", "type", "dimensions", "inputs", "outputs", "internal_links", "select", "texture_mapping", "color_mapping", "image_user", "color_ramp", "hops")
                    ...
                    # LINKS           
                    if self.tex_coord.label == 'Decal' or self.tex_coord.label == 'View' or self.tex_coord.label == 'Box':
                        self.node_tree.links.new(self.tex_coord.outputs[0], self.diffuse_mapping.inputs[0])
                        self.node_tree.links.new(self.tex_coord.outputs[0], self.rough_mapping.inputs[0])
                        self.node_tree.links.new(self.tex_coord.outputs[0], self.bump_mapping.inputs[0])
                        self.node_tree.links.new(self.tex_coord.outputs[0], self.alpha_mapping.inputs[0])
                    ...
                    self.node_tree.links.new(self.rough_tex.outputs[0], self.rough_hue_sat.inputs[4])
                    ...
                    self.node_tree.links.new(self.rough_bright_contrast.outputs[0], self.new_shader.inputs[9])
                    
                    self.node_tree.links.new(self.rough_bright_contrast.outputs[0], self.rough_clamp.inputs[0])
                    self.node_tree.links.new(self.rough_clamp.outputs[0], self.new_shader.inputs[9])
                        
                    self.node_tree.links.new(self.bump_tex.outputs[0], self.bump_hue_sat.inputs[4])
                    ...
                    self.node_tree.links.new(self.bump_bump.outputs[0], self.new_shader.inputs[22])
                    ...
                    self.node_tree.links.new(self.alpha_clamp.outputs[0], self.new_shader.inputs[21])
                ...
                if bpy.context.window_manager.my_toolqt.blend == 0:
                    ...
                    if not self.randcolor:
                        ...
                        with bpy.data.libraries.load(fullpath, link=False) as (data_from, data_to):
                            data_to.node_groups = [name for name in data_from.node_groups if name.startswith("QT_RandColor")]
                        ...
                        self.randcolor.name = 'QT_RandColor_' + str(bpy.context.window_manager.my_toolqt.activelayer)

                        self.randcolor.location = self.diffuse_bright_contrast.location
                        self.randcolor.location.x += 200

                        self.node_tree.links.new(self.diffuse_bright_contrast.outputs[0], self.randcolor.inputs[0])
                        self.node_tree.links.new(self.randcolor.outputs[0], self.core_shader.inputs[0])
                    ...
                    if not self.randval:
                        ...
                        fullpath = os.path.join(dirpath, 'QT_GeoNodes.blend') 
                        with bpy.data.libraries.load(fullpath, link=False) as (data_from, data_to):
                            data_to.node_groups = [name for name in data_from.node_groups if name.startswith("QT_RandVal")]
                        ...
                        self.randval.name = 'QT_RandVal_' + str(bpy.context.window_manager.my_toolqt.activelayer)

                        self.randval.location = self.roughness_clamp.location
                        self.randval.location.x += 200

                        self.node_tree.links.new(self.roughness_clamp.outputs[0], self.randval.inputs[0])
                        self.node_tree.links.new(self.randval.outputs[0], self.core_shader.inputs[9])
                ...
                if self.shift == 1 and self.ctrl == 1 and self.alt == 0:
                    ...
                    if bpy.context.window_manager.my_toolqt.blend == 0 and bpy.context.window_manager.my_toolqt.mask == 0:    
                        ...
                        if bpy.context.window_manager.my_toolqt.activelayer > 1:
                            ...
                            # set parameters
                            bpy.context.window_manager.my_toolqt.emit = self.core_shader.inputs[20].default_value
                            bpy.context.window_manager.my_toolqt.metal = int(self.core_shader.inputs[6].default_value)
                            bpy.context.window_manager.my_toolqt.bump = self.bump_bump.inputs[0].default_value
                            bpy.context.window_manager.my_toolqt.spec = self.core_shader.inputs[7].default_value
                            bpy.context.window_manager.my_toolqt.sss = self.core_shader.inputs[1].default_value
            ...
            # PREVIEW ALL LAYERS
                ...
                if bpy.context.window_manager.my_toolqt.blend == 0:    
                    ...
                    if not self.diffuse_seamless:
                        ...
                        fullpath = os.path.join(dirpath, 'QT_GeoNodes.blend') 
                        with bpy.data.libraries.load(fullpath, link=False) as (data_from, data_to):
                            data_to.node_groups = [name for name in data_from.node_groups if name.startswith("QT_Blend")]
                        ...
                        for i in range(5):
                            ...
                            if self.nodes:
                                for n in self.nodes:
                                    ...
                                    # normal
                                    if n.name.startswith('QT_Normal_Tex_' + str(layernum)):
                                        normal_tex = n

                                    # mapping                                 
                                    if n.name.startswith('QT_Diffuse_Mapping_' + str(layernum)):
                                        diffuse_mapping = n
                                    if n.name.startswith('QT_Rough_Mapping_' + str(layernum)):
                                        rough_mapping = n
                                    if n.name.startswith('QT_Bump_Mapping_' + str(layernum)):
                                        bump_mapping = n

                                    # textures
                                    if n.name.startswith('QT_Diffuse_Tex_' + str(layernum)):
                                        diffuse_tex = n
                                    if n.name.startswith('QT_Rough_Tex_' + str(layernum)):
                                        rough_tex = n
                                    if n.name.startswith('QT_Bump_Tex_' + str(layernum)):
                                        bump_tex = n
                                    ...
                                    if n.name.startswith('QT_Diffuse_Seamless_' + str(layernum)):
                                        diffuse_seamless = n

                            if not diffuse_seamless:
                                if diffuse_tex:
                                    seamless = original_group.copy()
                                    seamless_diffuse_node = self.nodes.new(type='ShaderNodeGroup')
                                    seamless_diffuse_node.node_tree = bpy.data.node_groups[seamless.name]
                                    seamless_diffuse_node.name = 'QT_Diffuse_Seamless_' + str(layernum)

                                    seamless_diffuse_node.location = diffuse_mapping.location

                                    self.node_tree.links.new(diffuse_mapping.outputs[0], seamless_diffuse_node.inputs[0])
                                    self.node_tree.links.new(seamless_diffuse_node.outputs[0], diffuse_tex.inputs[0])

                                    if normal_tex:
                                        self.node_tree.links.new(diffuse_mapping.outputs[0], seamless_diffuse_node.inputs[0])
                                        self.node_tree.links.new(seamless_diffuse_node.outputs[0], normal_tex.inputs[0])
                                    if ao_tex:
                                        self.node_tree.links.new(diffuse_mapping.outputs[0], seamless_diffuse_node.inputs[0])
                                        self.node_tree.links.new(seamless_diffuse_node.outputs[0], ao_tex.inputs[0])

                                    seamless_rough_node = self.nodes.new(type='ShaderNodeGroup')
                                    seamless_rough_node.node_tree = bpy.data.node_groups[seamless.name]
                                    seamless_rough_node.name = 'QT_Rough_Seamless_' + str(layernum)

                                    seamless_rough_node.location = rough_mapping.location

                                    self.node_tree.links.new(rough_mapping.outputs[0], seamless_rough_node.inputs[0])
                                    self.node_tree.links.new(seamless_rough_node.outputs[0], rough_tex.inputs[0])

                                    seamless_bump_node = self.nodes.new(type='ShaderNodeGroup')
                                    seamless_bump_node.node_tree = bpy.data.node_groups[seamless.name]
                                    seamless_bump_node.name = 'QT_Bump_Seamless_' + str(layernum)

                                    seamless_bump_node.location = bump_mapping.location

                                    self.node_tree.links.new(bump_mapping.outputs[0], seamless_bump_node.inputs[0])
                                    self.node_tree.links.new(seamless_bump_node.outputs[0], bump_tex.inputs[0])
...
# INVOKE
    def invoke(self, context, event):
        ...
        if len(sel) > 0:
            ...
            bpy.context.window_manager.my_toolqt.matindex = len(sel[0].material_slots)-1
...
class QT_OT_boxlayer_qt(Operator, ImportHelper):
    ...
    def execute(self, context):
        ...
        objects.box_layer(self, context, img_spec, ob.data.materials[bpy.context.window_manager.my_toolqt.matindex], bpy.context.window_manager.my_toolqt.activelayer, self.files, dirname, bpy.context.window_manager.my_toolqt.decal, bpy.context.window_manager.my_toolqt.selected)
...
class QT_OT_viewlayer_qt(Operator, ImportHelper):
    ...
    def execute(self, context):
        ...
        size = width/height
        bpy.context.window_manager.my_toolqt.activemap = 1
        objects.view_layer(self, context, img_spec, ob.data.materials[bpy.context.window_manager.my_toolqt.matindex], bpy.context.window_manager.my_toolqt.activelayer, self.files, dirname, bpy.context.window_manager.my_toolqt.decal, bpy.context.window_manager.my_toolqt.selected)
...
class QT_OT_texturemask_qt(Operator, ImportHelper):
    ...
    def poll(self,context):
        ...
        if bpy.context.window_manager.my_toolqt.activelayer > 1:
            if bpy.context.window_manager.my_toolqt.selected:
                if bpy.context.window_manager.my_toolqt.ob:
                    if len(bpy.context.window_manager.my_toolqt.ob.material_slots) > 0:
                        mat = bpy.context.window_manager.my_toolqt.ob.material_slots[bpy.context.window_manager.my_toolqt.matindex].material
                        if mat:                    
                            for n in mat.node_tree.nodes:
                                if n.name.startswith('QT_Shader'):
    ...
    def execute(self, context):
        ...
        if len(self.files) > 0:
            ...
            size = width/height
            bpy.context.window_manager.my_toolqt.activemap = 4
            objects.texture_mask(self, context, img_spec, ob.data.materials[bpy.context.window_manager.my_toolqt.matindex], bpy.context.window_manager.my_toolqt.activelayer, bpy.context.window_manager.my_toolqt.proc_uv)
...
class QT_OT_depthmask_qt(Operator, ImportHelper):
    ...
    def execute(self, context):
        ...
        if len(self.files) > 0:
            ...
            size = width/height
            bpy.context.window_manager.my_toolqt.activemap = 4
            objects.depth_mask(self, context, img_spec, ob.data.materials[bpy.context.window_manager.my_toolqt.matindex], bpy.context.window_manager.my_toolqt.activelayer, bpy.context.window_manager.my_toolqt.proc_uv)
...
class QT_OT_heightmask_qt(Operator):
    ...
    def execute(self, context):
        ...
        bpy.context.window_manager.my_toolqt.activemap = 4
        bpy.context.window_manager.my_toolqt.mask = 1
        objects.height_mask(self, context, ob.data.materials[bpy.context.window_manager.my_toolqt.matindex], bpy.context.window_manager.my_toolqt.activelayer)
...
class QT_OT_normalmask_qt(Operator):
    ...
    def execute(self, context):
        ...
        bpy.context.window_manager.my_toolqt.activemap = 4
        bpy.context.window_manager.my_toolqt.mask = 1
        objects.normal_mask(self, context, ob.data.materials[bpy.context.window_manager.my_toolqt.matindex], bpy.context.window_manager.my_toolqt.activelayer)
...
class QT_OT_smudge_qt(Operator, ImportHelper):
    ...
    def execute(self, context):
        ...
        if len(self.files) > 0:
            ...
            size = width/height
            bpy.context.window_manager.my_toolqt.activemap = 7
            objects.smudge_mask(self, context, img_spec, ob.data.materials[bpy.context.window_manager.my_toolqt.matindex], bpy.context.window_manager.my_toolqt.activelayer, bpy.context.window_manager.my_toolqt.proc_uv)
        ...
        if procuvs:          
            ...
            for ob in sel:                
                if ob != act:
                    ...
                    if not mod2_check:
                        if mod2:
                            rmod1 = ob.modifiers.new(name='QT_UV_View_Layer_2', type='UV_PROJECT')
                            rmod1.projector_count = 1
                    ...
                    if not mod3_check:
                        if mod3:
                            rmod1 = ob.modifiers.new(name='QT_UV_View_Layer_3', type='UV_PROJECT')
                            rmod1.projector_count = 1
                    ...
                    if not mod4_check:
                        if mod4:
                            rmod1 = ob.modifiers.new(name='QT_UV_View_Layer_4', type='UV_PROJECT')
                            rmod1.projector_count = 1
                    ...
                    if not mod5_check:
                        if mod5:
                            rmod1 = ob.modifiers.new(name='QT_UV_View_Layer_5', type='UV_PROJECT')
                            rmod1.projector_count = 1
...
class QT_OT_decal_qt(Operator, ImportHelper):
    ...
    def execute(self, context):
        ...
        ob = objects.create_decal(self, context, sel, bpy.context.window_manager.my_toolqt.res, img_spec)
        mode = 'view'

        material = objects.create_material(self, context, img_spec, 1, mode, bpy.context.window_manager.my_toolqt.proc_uv, self.files, dirname, bpy.context.window_manager.my_toolqt.decal, bpy.context.window_manager.my_toolqt.selected)
        ...
        if len(sel) > 0:
            ...
            ob.location = ob.location -bpy.context.window_manager.my_toolqt.decal_raydir * pushback
            ...
            with bpy.data.libraries.load(fullpath, link=False) as (data_from, data_to):
                data_to.node_groups = [name for name in data_from.node_groups if name.startswith("Decal")]
...
# INVOKE
    def invoke(self, context, event):
        ...
        if len(sel) > 0:
            coord = event.mouse_region_x, event.mouse_region_y
            hitlocation, hitnormal, hitindex, hitobject = utils.ray_cast(self.region, self.rv3d, coord, context)
            if hitobject:
        ...
        bpy.context.window_manager.my_toolqt.decal_raydir = Vector((self.rv3d.perspective_matrix[2][0:3])).normalized()
    ...
    def Bake(self, context):
        ...
        if obj and len(obj.data.materials) > 0:
            ...
            for i in range(len(maplist)):
                ...
                bake_image = bpy.data.images.new(bake_spec,bpy.context.window_manager.my_toolqt.bakeres,bpy.context.window_manager.my_toolqt.bakeres)
                ...
                while bpy.ops.object.bake('INVOKE_DEFAULT', type = maplist[i]) != {'RUNNING_MODAL'}:
                    yield 1
        ...
        if event.type == 'TIMER':
            ...
            if result == 0:
                ...
                for i in range(len(obj.data.materials)):
                    if i > 0:
                        bpy.data.materials.remove(obj.data.materials[i])
