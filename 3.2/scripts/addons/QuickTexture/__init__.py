bl_info = {
    ...
    "description": "Sketching in 3D for Concept Artists VfxMed",
    "wiki_url": "http://www.alksndr.com/quicktexture",
    "tracker_url": "http://www.alksndr.com/quicktexture",
    "category": "Mesh"
}

import bpy
from bpy.utils import register_class, unregister_class
from . operators import (MyPropertiesQT, QT_PT_panel, quickTexture, quickDecal, draw_quickTexture, QT_OT_material_qt, QT_OT_boxlayer_qt, QT_OT_texturemask_qt, QT_OT_heightmask_qt, QT_OT_depthmask_qt, 
    QT_OT_viewlayer_qt, QT_OT_replacemaps_qt, QT_OT_smudge_qt, QT_OT_replacealpha_qt, QT_OT_normalmask_qt, QT_OT_copymats, QT_OT_makeunique, QT_OT_decal_qt, VIEW3D_MT_QT_PIE1, BakeFileSelector, bakeTextures)
from bpy.props import FloatProperty, IntProperty, BoolProperty, StringProperty, FloatVectorProperty, PointerProperty
