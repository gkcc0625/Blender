...
def extend(obj, EXTEND_MODE):
    ...
    with Timer() as t_avg:
        ...
        # print("Edge_length: ", edge_lengths)
    # print("'LENGTH_AVERAGE' calc time: ", t_avg.delta())
...
class ZUV_OT_Follow(Operator):
    """Follow UVs from active quads along continuous face loops"""
    bl_idname = "uv.zenuv_follow_active_quads"
    ...
    def execute(self, context):
        ...
        main(context, self)
        # print("\nFollow Finished in:", t_global.delta())
        return {'FINISHED'}
