...
class UICleanUpToolsModule(Panel):
    ...
    def draw(self, context):
        ...
        col.prop(context.scene.kekit, "clean_doubles")
        col.prop(context.scene.kekit, "clean_loose")
        col.prop(context.scene.kekit, "clean_interior")
        col.prop(context.scene.kekit, "clean_degenerate")
        col.prop(context.scene.kekit, "clean_collinear")
        col.prop(context.scene.kekit, "clean_tinyedge")
        col.prop(context.scene.kekit, "clean_tinyedge_val")
...
class KeClean(Operator):
    ...
    def execute(self, context):
        # props
        doubles = context.scene.kekit.clean_doubles
        doubles_val = bpy.context.scene.kekit.clean_doubles_val
        loose = context.scene.kekit.clean_loose
        interior = context.scene.kekit.clean_interior
        degenerate = context.scene.kekit.clean_degenerate
        collinear = context.scene.kekit.clean_collinear
        tinyedges = context.scene.kekit.clean_tinyedge_val
        tinyedges_val = context.scene.kekit.clean_tinyedge_val
