...
from .ke_utils import get_loops, average_vector, get_duplicates
...
class VIEW3D_OT_ke_selmode(Operator):
    ...
    bl_description = "LEGACY FEATURE - Only here for 'Mouse Over Element Select Mode' support\n" \
                     "Sets Element Mode - Direct to selection mode, also from Object Mode"
    ...
    def description(cls, context, properties):
        if properties.edit_mode == "VERT":
            return "LEGACY FEATURE - Only here for 'Mouse Over Element Select Mode' support\n" \
                   "Direct to Vertex Element Mode in Edit Mode"
        elif properties.edit_mode == "EDGE":
            return "LEGACY FEATURE - Only here for 'Mouse Over Element Select Mode' support\n" \
                   "Direct to Edge Element Mode in Edit Mode"
        elif properties.edit_mode == "FACE":
            return "LEGACY FEATURE - Only here for 'Mouse Over Element Select Mode' support\n" \
                   "Direct to Face Element Mode in Edit Mode"
        elif properties.edit_mode == "OBJECT":
            return "LEGACY FEATURE - Only here for 'Mouse Over Element Select Mode' support\n" \
                   "Direct to Object Mode"
        else:
            return "LEGACY FEATURE - Only here for 'Mouse Over Element Select Mode' support\n" \
                   "Set Element Mode - Direct to selection mode from Object Mode"
