...
# -------------------------------------------------------------------------------------------------
# Note: This kit is very much WIP - ..and experimental. ->  Frankensteins monster.
# -------------------------------------------------------------------------------------------------

from . import _prefs_keymap
from . import _prefs
...
class VIEW3D_PT_kekit_modeling(Panel):
    ...
    def draw(self, context):
        ...
        col.operator('MESH_OT_merge_to_mouse', icon="MOUSE_MOVE")
...
class VIEW3D_PT_Clean(Panel):
    ...
    def draw(self, context):
        ...
        col.operator('MESH_OT_ke_select_collinear')
...
class VIEW3D_PT_Context_Tools(Panel):
    ...
    def draw(self, context):
        ...
        scol.separator()
        srow = scol.row(align=True)
        srow.operator("view3d.ke_tt", text="Dupe Linked Toggle", icon='LINKED', depress=tt_link).mode = "TOGGLE_DUPE"
        srow.operator('view3d.ke_tt', text="", icon="UNLINKED").mode = "F_DUPE"
        srow.operator('view3d.ke_tt', text="", icon="LINKED").mode = "F_LINKDUPE"
        col.separator()
        sub = col.box()
        scol = sub.column(align=True)
        srow = scol.row(align=True)
        ...
        col.operator('MESH_OT_ke_context_connect', text="Context Connect")
...
class VIEW3D_PT_Select_by_displaytype(Panel):
...
# MENU
# -------------------------------------------------------------------------------------------------
class VIEW3D_PT_OLD_SELMODES(Panel):
    bl_label = "Mode Select/Toggle"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = 'keKIT'
    ...
    def draw(self, context):
        ...
        row = layout.row(align=False)
        row.operator('VIEW3D_OT_ke_spacetoggle', text="Space Toggle", icon="MOUSE_MOVE")
...
panels = (
        VIEW3D_PT_kekit,
        VIEW3D_PT_OLD_SELMODES,
        VIEW3D_PT_kekit_modeling,
        VIEW3D_PT_Context_Tools,
        VIEW3D_PT_OPC,
        VIEW3D_PT_PieMenus,
        VIEW3D_PT_Select_by_displaytype,
        )
