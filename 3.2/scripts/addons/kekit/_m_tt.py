...
class UITTModule(Panel):
    ...
    def draw(self, context):
        ...
        srow = scol.row(align=True)
        srow.prop(context.scene.kekit, "tt_handles", text="Handle")
        srow.prop(context.scene.kekit, "tt_select", text="SelTool")
        srow.prop(context.scene.kekit, "mam_scl", text="MAS")
        scol.separator()
        if tt_link:
        ...
        scol.prop(context.scene.kekit, "loc_got")
        scol.prop(context.scene.kekit, "rot_got")
        scol.prop(context.scene.kekit, "scl_got")
        scol.prop(context.scene.kekit, "vptransform", toggle=True)
