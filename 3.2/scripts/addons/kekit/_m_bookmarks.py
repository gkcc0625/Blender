...
class UISnapComboNames(Panel):
    ...
    def draw(self, context):
        ...
        col.prop(bpy.context.scene.kekit, "snap_name1", text="")
        col.prop(bpy.context.scene.kekit, "snap_name2", text="")
        col.prop(bpy.context.scene.kekit, "snap_name3", text="")
        col.prop(bpy.context.scene.kekit, "snap_name4", text="")
        col.prop(bpy.context.scene.kekit, "snap_name5", text="")
        col.prop(bpy.context.scene.kekit, "snap_name6", text="")
        col.prop(bpy.context.scene.kekit, "combo_autosnap")
...
class UISnapCombos(Panel):
    ...
    def draw(self, context):
        ...
        col.operator('view3d.ke_snap_combo', text="1").mode = "SET1"
        col = row.column(align=True)
        col.operator('view3d.ke_snap_combo', icon="IMPORT", text="").mode = "GET2"
        col.operator('view3d.ke_snap_combo', text="2").mode = "SET2"
        col = row.column(align=True)
        col.operator('view3d.ke_snap_combo', icon="IMPORT", text="").mode = "GET3"
        col.operator('view3d.ke_snap_combo', text="3").mode = "SET3"
        col = row.column(align=True)
        col.operator('view3d.ke_snap_combo', icon="IMPORT", text="").mode = "GET4"
        col.operator('view3d.ke_snap_combo', text="4").mode = "SET4"
        col = row.column(align=True)
        col.operator('view3d.ke_snap_combo', icon="IMPORT", text="").mode = "GET5"
        col.operator('view3d.ke_snap_combo', text="5").mode = "SET5"
        col = row.column(align=True)
        col.operator('view3d.ke_snap_combo', icon="IMPORT", text="").mode = "GET6"
        col.operator('view3d.ke_snap_combo', text="6").mode = "SET6"
...
class KeSnapCombo(Operator):
    ...
    def execute(self, context):
        ...
        if mode == "GET":
            ...
            if context.scene.kekit.combo_autosnap:
...
class UIopc1(Panel):
    ...
    def draw(self, context):
        name = context.scene.kekit.opc1_name
        toggle = context.scene.kekit_temp.toggle

        layout = self.layout
        row = layout.row(align=True)
        if toggle:
            row.prop(context.scene.kekit, "opc1_name", text="")
...
class UIopc2(Panel):
    ...
    def draw(self, context):
        name = context.scene.kekit.opc2_name
        toggle = context.scene.kekit_temp.toggle

        layout = self.layout
        row = layout.row(align=True)
        if toggle:
            row.prop(context.scene.kekit, "opc2_name", text="")
            row.alignment = "CENTER"
            row.prop(context.scene.kekit_temp, "toggle", text="Name", toggle=True)
        else:
...
class UIopc3(Panel):
    ...
    def draw(self, context):
        name = context.scene.kekit.opc3_name
        toggle = context.scene.kekit_temp.toggle

        layout = self.layout
        row = layout.row(align=True)
        if toggle:
            row.prop(context.scene.kekit, "opc3_name", text="")
            row.alignment = "CENTER"
            row.prop(context.scene.kekit_temp, "toggle", text="Name", toggle=True)
        else:
...
class UIopc4(Panel):
    ...
    def draw(self, context):
        name = context.scene.kekit.opc4_name
        toggle = context.scene.kekit_temp.toggle

        layout = self.layout
        row = layout.row(align=True)
        if toggle:
            row.prop(context.scene.kekit, "opc4_name", text="")
            row.alignment = "CENTER"
            row.prop(context.scene.kekit_temp, "toggle", text="Name", toggle=True)
        else:
...
class UIopc5(Panel):
    ...
    def draw(self, context):
        name = context.scene.kekit.opc5_name
        toggle = context.scene.kekit_temp.toggle

        layout = self.layout
        row = layout.row(align=True)
        if toggle:
            row.prop(context.scene.kekit, "opc5_name", text="")
            row.alignment = "CENTER"
            row.prop(context.scene.kekit_temp, "toggle", text="Name", toggle=True)
        else:
        ...
        col.prop(context.scene.kekit, 'opc5_obj_o', text="Orient")
        col.prop(context.scene.kekit, 'opc5_obj_p', text="Pivot")
        col.label(text="OPC5 Edit Mode")
        col.prop(context.scene.kekit, 'opc5_edit_o', text="Orientation")
        col.prop(context.scene.kekit, 'opc5_edit_p', text="Pivot")
...
class UIopc6(Panel):
    ...
    def draw(self, context):
        name = context.scene.kekit.opc6_name
        toggle = context.scene.kekit_temp.toggle

        layout = self.layout
        row = layout.row(align=True)
        if toggle:
            row.prop(context.scene.kekit, "opc6_name", text="")
            row.alignment = "CENTER"
            row.prop(context.scene.kekit_temp, "toggle", text="Name", toggle=True)
        else:
        ...
        col.prop(context.scene.kekit, 'opc6_obj_o', text="Orient")
        col.prop(context.scene.kekit, 'opc6_obj_p', text="Pivot")
        col.label(text="OPC6 Edit Mode")
        col.prop(context.scene.kekit, 'opc6_edit_o', text="Orientation")
        col.prop(context.scene.kekit, 'opc6_edit_p', text="Pivot")
...
class KeOPC(Operator):
    ...
    def execute(self, context):
        ...
        if ctx_mode == "OBJECT":
            if self.combo == "1":
                orientation = context.scene.kekit.opc1_obj_o[1:]
                pivot = context.scene.kekit.opc1_obj_p[1:]
            elif self.combo == "2":
                orientation = context.scene.kekit.opc2_obj_o[1:]
                pivot = context.scene.kekit.opc2_obj_p[1:]
            elif self.combo == "3":
                orientation = context.scene.kekit.opc3_obj_o[1:]
                pivot = context.scene.kekit.opc3_obj_p[1:]
            elif self.combo == "4":
                orientation = context.scene.kekit.opc4_obj_o[1:]
                pivot = context.scene.kekit.opc4_obj_p[1:]
            elif self.combo == "5":
                orientation = context.scene.kekit.opc5_obj_o[1:]
                pivot = context.scene.kekit.opc5_obj_p[1:]
            elif self.combo == "6":
                orientation = context.scene.kekit.opc6_obj_o[1:]
                pivot = context.scene.kekit.opc6_obj_p[1:]

        else:
            if self.combo == "1":
                orientation = context.scene.kekit.opc1_edit_o[1:]
                pivot = context.scene.kekit.opc1_edit_p[1:]
            elif self.combo == "2":
                orientation = context.scene.kekit.opc2_edit_o[1:]
                pivot = context.scene.kekit.opc2_edit_p[1:]
            elif self.combo == "3":
                orientation = context.scene.kekit.opc3_edit_o[1:]
                pivot = context.scene.kekit.opc3_edit_p[1:]
            elif self.combo == "4":
                orientation = context.scene.kekit.opc4_edit_o[1:]
                pivot = context.scene.kekit.opc4_edit_p[1:]
            elif self.combo == "5":
                orientation = context.scene.kekit.opc5_edit_o[1:]
                pivot = context.scene.kekit.opc5_edit_p[1:]
            elif self.combo == "6":
                orientation = context.scene.kekit.opc6_edit_o[1:]
                pivot = context.scene.kekit.opc6_edit_p[1:]
