...
class BendFaceOperator(bpy.types.Operator):
    ...
    def mouse_release(self, context):
        ...
        #self.bm = None
        #self.bmmap = {}
        #gui.txtall = ['Left-mouse: Rotate', 'Right-mouse: Move', 'Hold Ctrl: snapping, F key: face normal', 'Press Esc to cancel.']
        self.hint()
        self.prepare_fn()
        #self.down = False
    ...
    def run_rotate(self, context, event):
        ...
        gui.txtall = ['Rotation angle : ' + "{:0.2f}".format(p4) + '' ]
        deg = math.radians(p4)
        self.prop_rotate = p4        
    ...
    def run_move(self, context, event):
        ...
        if event.ctrl:
            p4 = p4 - (p4 % 0.25)            
        gui.txtall = ['Moving : ' + "{:0.2f}".format(p4) + '' ]
    ...
    def hint(self):
        if self.prop_extend_mode:
            gui.txtall = ['Sliding rotation', 'Left-mouse: Rotate', 'Right-mouse: Move', 'Hold Ctrl: snapping, F key: face normal', 'S key: sliding mode', 'Press Esc to cancel.']
        else:
            gui.txtall = ['Left-mouse: Rotate', 'Right-mouse: Move', 'Hold Ctrl: snapping, F key: face normal', 'S key: sliding mode', 'Press Esc to cancel.']
