...
class PunchIt(bpy.types.Operator):
    ...
    def draw_HUD(self, args):
        ...
        if self.finalizing:
            ...
            if self.use_self:
                draw_label(context, title="magically", coords=Vector((self.HUD_x + 90 * scale, self.HUD_y)), center=False, color=white, alpha=0.5)
            ...
            draw_label(context, title=f"Pulled: {self.pulled}", coords=Vector((self.HUD_x + 90 * scale, self.HUD_y - offset)), center=False, color=green, alpha=0.5)
