...
# Hacked version of Blender's Smart Projection
...
def island2Edge(island):
    ...
    length_sorted_edges.sort(key=lambda a: -a[2])  # biggest first
...
def smart_project(me, projection_limit=66.0, user_area_weight=0.0, stretch_to_bounds=True, island_margin=0.0):
